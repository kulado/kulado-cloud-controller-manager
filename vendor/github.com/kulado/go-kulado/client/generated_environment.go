...
func newEnvironmentClient(kuladoClient *KuladoClient) *EnvironmentClient {
...
func (c *EnvironmentClient) Create(container *Environment) (*Environment, error) {
	resp := &Environment{}
	err := c.kuladoClient.doCreate(ENVIRONMENT_TYPE, container, resp)
	return resp, err
}

func (c *EnvironmentClient) Update(existing *Environment, updates interface{}) (*Environment, error) {
	resp := &Environment{}
	err := c.kuladoClient.doUpdate(ENVIRONMENT_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *EnvironmentClient) List(opts *ListOpts) (*EnvironmentCollection, error) {
	resp := &EnvironmentCollection{}
	err := c.kuladoClient.doList(ENVIRONMENT_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *EnvironmentClient) ById(id string) (*Environment, error) {
	resp := &Environment{}
	err := c.kuladoClient.doById(ENVIRONMENT_TYPE, id, resp)
...
func (c *EnvironmentClient) Delete(container *Environment) error {
	return c.kuladoClient.doResourceDelete(ENVIRONMENT_TYPE, &container.Resource)
}
...
func (c *EnvironmentClient) ActionActivateservices(resource *Environment) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "activateservices", &resource.Resource, nil, resp)
...
func (c *EnvironmentClient) ActionAddoutputs(resource *Environment, input *AddOutputsInput) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "addoutputs", &resource.Resource, input, resp)
...
func (c *EnvironmentClient) ActionCancelrollback(resource *Environment) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "cancelrollback", &resource.Resource, nil, resp)
...
func (c *EnvironmentClient) ActionCancelupgrade(resource *Environment) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "cancelupgrade", &resource.Resource, nil, resp)
...
func (c *EnvironmentClient) ActionCreate(resource *Environment) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *EnvironmentClient) ActionDeactivateservices(resource *Environment) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "deactivateservices", &resource.Resource, nil, resp)
...
func (c *EnvironmentClient) ActionError(resource *Environment) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *EnvironmentClient) ActionExportconfig(resource *Environment, input *ComposeConfigInput) (*ComposeConfig, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "exportconfig", &resource.Resource, input, resp)
...
func (c *EnvironmentClient) ActionFinishupgrade(resource *Environment) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "finishupgrade", &resource.Resource, nil, resp)
...
func (c *EnvironmentClient) ActionRemove(resource *Environment) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *EnvironmentClient) ActionRollback(resource *Environment) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "rollback", &resource.Resource, nil, resp)
...
func (c *EnvironmentClient) ActionUpdate(resource *Environment) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "update", &resource.Resource, nil, resp)
...
func (c *EnvironmentClient) ActionUpgrade(resource *Environment, input *EnvironmentUpgrade) (*Environment, error) {
	...
	err := c.kuladoClient.doAction(ENVIRONMENT_TYPE, "upgrade", &resource.Resource, input, resp)
