...
func (c *CredentialClient) ActionPurge(resource *Credential) (*Credential, error) {
	...
	err := c.kuladoClient.doAction(CREDENTIAL_TYPE, "purge", &resource.Resource, nil, resp)
...
func (c *CredentialClient) ActionUpdate(resource *Credential) (*Credential, error) {
	...
	err := c.kuladoClient.doAction(CREDENTIAL_TYPE, "update", &resource.Resource, nil, resp)
