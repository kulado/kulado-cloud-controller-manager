...
func newComposeServiceClient(kuladoClient *KuladoClient) *ComposeServiceClient {
...
func (c *ComposeServiceClient) ById(id string) (*ComposeService, error) {
	resp := &ComposeService{}
	err := c.kuladoClient.doById(COMPOSE_SERVICE_TYPE, id, resp)
...
func (c *ComposeServiceClient) Delete(container *ComposeService) error {
	return c.kuladoClient.doResourceDelete(COMPOSE_SERVICE_TYPE, &container.Resource)
}
...
func (c *ComposeServiceClient) ActionActivate(resource *ComposeService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_SERVICE_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *ComposeServiceClient) ActionCancelupgrade(resource *ComposeService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_SERVICE_TYPE, "cancelupgrade", &resource.Resource, nil, resp)
...
func (c *ComposeServiceClient) ActionContinueupgrade(resource *ComposeService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_SERVICE_TYPE, "continueupgrade", &resource.Resource, nil, resp)
...
func (c *ComposeServiceClient) ActionCreate(resource *ComposeService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_SERVICE_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *ComposeServiceClient) ActionFinishupgrade(resource *ComposeService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_SERVICE_TYPE, "finishupgrade", &resource.Resource, nil, resp)
...
func (c *ComposeServiceClient) ActionRemove(resource *ComposeService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_SERVICE_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *ComposeServiceClient) ActionRollback(resource *ComposeService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_SERVICE_TYPE, "rollback", &resource.Resource, nil, resp)
