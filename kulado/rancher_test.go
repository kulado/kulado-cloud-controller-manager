...
var (
	testClient    *client.KuladoClient
...
type fakeKuladoBaseClient struct {
	client.KuladoBaseClientImpl
}

func (f *fakeKuladoBaseClient) GetLink(resource client.Resource, link string, respObject interface{}) error {
	switch link {
	case "ipAddresses":
...
func TestMain(m *testing.M) {
	...
	testClient = &client.KuladoClient{
		KuladoBaseClient: &fakeKuladoBaseClient{
			KuladoBaseClientImpl: client.KuladoBaseClientImpl{
